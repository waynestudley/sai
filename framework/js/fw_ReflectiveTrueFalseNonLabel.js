/*----------------------------------------
	Name: fw_ReflectiveTrueFalseNonLabel.js
	Developed by: Suyog Shaha
----------------------------------------*/
function fw_ReflectiveTrueFalseNonLabel(_xml) {
    var pageXml = _xml;
    var optionButton = ".reflectiveTrueFalseNonLabel .optionButton";
    ...
    var optRow;
    $('.reflectiveTrueFalseNonLabel').addClass(className);
    ...
    for (var i = 0; i < totalQption; i++) {
		...
		str += '<td class="ImpactContainer" ><a href="javascript:void(0)" class="questionMark" id="impactBtn_'+i+'"></a></td>';
        tbCnt++;
        str += '</tr>';
        str += '<tr class="cellGap1"></tr>';
        tbCnt++;
   ...
   $('.optionCell').hover(function() {
    ...
    $('.questionMark').bind("click", function(e) {
		if ($(this).hasClass("disabled")) {
			return false;
		}
		$('.questionMark').removeClass("disabled");
    ...
    $('.impactCloseBtn').bind("click", function(e) {
        $('.impactFeedback').hide();
        $('.Arrow').hide();
		$('.userFeedback').show();
		$('.questionMark').removeClass("disabled");        
